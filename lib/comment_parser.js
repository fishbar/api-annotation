...
module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c29 = function(token, failure) {return failure},
        peg$c30 = function(token, example) {
            return {
              token: token,
              value: example
            }
          },
        peg$c31 = function(token) {
            return {
              token: token,
              value: true
            }
          },
        peg$c32 = function(token, info) {return info},
        peg$c33 = function(token, info) {
            return {
              token: token,
              value: info
            }
          },
        peg$c34 = { type: "other", description: "http methods" },
        peg$c35 = "{",
        peg$c36 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c37 = "|",
        peg$c38 = { type: "literal", value: "|", description: "\"|\"" },
        peg$c39 = function(method) {return method},
        peg$c40 = "}",
        ...
        peg$c43 = { type: "other", description: "http method" },
        peg$c44 = /^[a-zA-Z]/,
        ...
        peg$c52 = "@api",
        peg$c53 = { type: "literal", value: "@api", description: "\"@api\"" },
        peg$c54 = function() {return "api"},
        peg$c55 = { type: "other", description: "token @params" },
        peg$c56 = "@params",
        peg$c57 = { type: "literal", value: "@params", description: "\"@params\"" },
        peg$c58 = function() {return "params"},
        peg$c59 = { type: "other", description: "token @query" },
        peg$c60 = "@query",
        peg$c61 = { type: "literal", value: "@query", description: "\"@query\"" },
        peg$c62 = function() {return "query"},
        peg$c63 = { type: "other", description: "token @body" },
        peg$c64 = "@body",
        peg$c65 = { type: "literal", value: "@body", description: "\"@body\"" },
        peg$c66 = function() {return "body"},
        peg$c67 = { type: "other", description: "token @success" },
        peg$c68 = "@success",
        peg$c69 = { type: "literal", value: "@success", description: "\"@success\"" },
        peg$c70 = function() {return "success"},
        peg$c71 = { type: "other", description: "token @failure/@error" },
        peg$c72 = "failure",
        peg$c73 = { type: "literal", value: "failure", description: "\"failure\"" },
        peg$c74 = "error",
        peg$c75 = { type: "literal", value: "error", description: "\"error\"" },
        peg$c76 = function() {return "failure"},
        peg$c77 = { type: "other", description: "token @name" },
        peg$c78 = "@name",
        peg$c79 = { type: "literal", value: "@name", description: "\"@name\"" },
        peg$c80 = function() {return "name"},
        peg$c81 = { type: "other", description: "token @desc/@description" },
        peg$c82 = "description",
        peg$c83 = { type: "literal", value: "description", description: "\"description\"" },
        peg$c84 = "desc",
        peg$c85 = { type: "literal", value: "desc", description: "\"desc\"" },
        peg$c86 = function() {return "desc"},
        peg$c87 = { type: "other", description: "token @json" },
        peg$c88 = "@json",
        peg$c89 = { type: "literal", value: "@json", description: "\"@json\"" },
        peg$c90 = function() {return "json"},
        peg$c91 = { type: "other", description: "token @example" },
        peg$c92 = "@example",
        peg$c93 = { type: "literal", value: "@example", description: "\"@example\"" },
        peg$c94 = function() {return "example"},
        peg$c95 = { type: "other", description: "token FLAG" },
        peg$c96 = "private",
        peg$c97 = { type: "literal", value: "private", description: "\"private\"" },
        peg$c98 = "internal",
        peg$c99 = { type: "literal", value: "internal", description: "\"internal\"" },
        peg$c100 = "public",
        peg$c101 = { type: "literal", value: "public", description: "\"public\"" },
        peg$c102 = function(name) {return name},
        peg$c103 = { type: "other", description: "unknow token" },
        peg$c104 = function(name) {return "unknow:" + name},
        peg$c105 = /^[ \t]/,
        peg$c106 = { type: "class", value: "[ \\t]", description: "[ \\t]" },
        peg$c107 = { type: "other", description: "new line" },
        peg$c108 = /^[\n]/,
        peg$c109 = { type: "class", value: "[\\n]", description: "[\\n]" },
        peg$c110 = "",
        peg$c111 = { type: "other", description: "empty line or the end of the string" },
