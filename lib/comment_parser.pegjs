...
TOKEN_PARAMS "keyword @params" = "@params" {return "params"}
TOKEN_QUERY "keyword @query" = "@query" {return "query"}
TOKEN_BODY = "@body" {return "body"}
TOKEN_SUCCESS = "@success" {return "success"}
TOKEN_FAILURE = "@failure" {return "failure"}
TOKEN_NAME = "@name" {return "name"}
TOKEN_JSON = "@json" {return "json"}
TOKEN_DESC = "@" ("description" / "desc") {return "desc"}
TOKEN_UNKNOW "keyword undefined" = '@'name:$([a-z]+) {return "unknow:" + name}
