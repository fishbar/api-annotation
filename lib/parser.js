...
var debug = require('debug')('api-annotation');

var commentParser = require('./comment_parser');
var sectionParser = require('./section_parser');
...
function parseComment(comment, offsetLine) {
  ...
  var result = commentParser.parse(comment);
  var finalResult = {};
